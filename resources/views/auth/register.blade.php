<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="nomor" value="{{ __('Nomor Handphone') }}" />
                <x-jet-input id="nomor" class="block mt-1 w-full" type="text" name="nomor" :value="old('nomor')" required autofocus autocomplete="nomor" />
            </div>
            <div>
