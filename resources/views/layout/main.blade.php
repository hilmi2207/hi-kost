...
<html>
  ...
  <div class="wrapper">
                    ...
                    <div class="header-top row align-items-center">
                        <div class="col-lg-3">
                            <div class="brand">
                                ...
                                <img class="w-16 h-16" viewbox="0 0 48 48" fill="none" src="https://github.com/hilmi2207/foto/blob/main/HI-KOST.png?raw=true" alt="Logo">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="navbar navbar-expand-lg bg-light navbar-light">
                                ...
                                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                    <div class="navbar-nav ml-auto">
                                        ...
                                        <a href="{{url('/datas')}}" class="nav-item nav-link">Daftar Kost</a>
        ...
        <!-- Template Javascript -->
        <script src="js/main.js"></script><!-- Optional JavaScript; choose one of the two! -->
